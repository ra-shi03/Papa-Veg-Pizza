          ...
          <div className="flex items-center gap-2.5 overflow-hidden">
            ...
            {!displayCollapsed && (
              <div className="animate-fade-in whitespace-nowrap">
                ...
                <p className="text-[10px] text-black font-medium">Global Manager</p>
              </div>
            )}
          </div>
                ...
                <div key={groupIdx} className="space-y-1">
                  {!displayCollapsed ? (
                    ...
                    >
                      ...
                      <span className={`transition-transform duration-200 text-black ${isExpanded ? 'rotate-180' : ''}`}>
                      ...
                      {group.items.map((item, itemIdx) => {
                        ...
                        return (
                          ...
                          >
                            <Icon
                              size={15}
                              className={`shrink-0 transition-transform duration-300 ${isActive ? "text-primary dark:text-primary-foreground" : "text-zinc-500 group-hover:text-black"}`}
                            />
