    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center w-full max-w-5xl">
         ...
         >
            ...
            <div className="mt-8 flex flex-col items-center gap-3 text-xs font-medium">
              <Link 
                to="/franchise-admin/forgot-password"
                className="text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors underline-offset-4"
              >
                Forgot Password?
              </Link>
              <Link 
